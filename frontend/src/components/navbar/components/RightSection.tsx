		...
		<>
			<div className="hidden md:flex flex-row items-center gap-2 md:w-[200px] justify-end">
				...
				>
					...
					>
						<path
							d="M27.5589 22.7998L22.0825 17.8205C21.8238 17.5849 21.4836 17.4592 21.1338 17.47C20.7841 17.4809 20.4522 17.6273 20.2086 17.8785L16.9847 21.1939C16.2087 21.0457 14.6487 20.5594 13.0428 18.9576C11.4369 17.3504 10.9506 15.7863 10.8064 15.0157L14.1192 11.7905C14.3704 11.5468 14.5168 11.215 14.5276 10.8652C14.5385 10.5155 14.4128 10.1752 14.1771 9.9165L9.19924 4.44147C8.96353 4.18194 8.63594 4.02451 8.28604 4.00263C7.93613 3.98074 7.59148 4.09612 7.32528 4.32426L4.40185 6.83141C4.16893 7.06517 4.02991 7.37628 4.01116 7.70574C3.99095 8.04254 3.60565 16.0207 9.792 22.2097C15.1889 27.6053 21.9492 28 23.811 28C24.0831 28 24.2502 27.9919 24.2946 27.9892C24.6238 27.9698 24.9344 27.8303 25.1676 27.5972L27.6734 24.6724C27.9025 24.4071 28.0187 24.0627 27.9973 23.7128C27.9759 23.3629 27.8186 23.0353 27.5589 22.7998Z"
							fill="black"
						/>
					</svg>
				</div>
